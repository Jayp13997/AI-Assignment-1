...
public class astarMaxG{
	...
	public astarMaxG(Grid g, int sx, int sy, int gx, int gy) {
		grid = g;
		this.sx = sx;
		this.sy = sy;
		this.gx = gx;
	...
	public void runRepeatedMax() {
			...
			System.out.println("TOTAL EXPANDED Forward Max A" +  totalExpanded);
